...
namespace Memory
{
   ...
   NRESULT NMemory::initMemory(NSize_t uReservationSize)
   {
      ...
      NAssert(isInitializated(), "Double initialization");
   ...
   /***********************************************************************/
   /***********************************************************************/
   NMemory& NMemory::GetGlobalInstance()
   {
      if(!m_instance.isInitializated())
      {
         m_instance.initMemory();
      }
